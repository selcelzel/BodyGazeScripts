...
public class EyeTrackingDataCollectorAndExporter2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        filePath = System.Environment.GetFolderPath(System.Environment.SpecialFolder.Desktop) + "/eye_tracking_data2.txt";
